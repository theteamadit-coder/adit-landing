        ...
        <div className="space-y-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="order-2 md:order-1">
              <h3 className="text-3xl font-bold text-heading mb-4">01 네이버 배너 광고</h3>
              <p className="text-lg text-heading mb-6 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              <h3 className="text-3xl font-bold text-heading mb-4">02 Google GDN</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="order-2 md:order-1">
              <h3 className="text-3xl font-bold text-heading mb-4">03 카카오모먼트</h3>
              <p className="text-xl font-semibold text-primary leading-relaxed mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="w-full aspect-video bg-gray-300 rounded-xl"></div>
            <div>
              <h3 className="text-3xl font-bold text-heading mb-4">04 당근마켓 배너광고</h3>
              <p className="text-xl font-semibold text-primary leading-relaxed">
